...
(use-package! lsp-tailwindcss
  ...
  ;; Lucid
  (after! haskell-mode (push 'haskell-mode lsp-tailwindcss-major-modes)
...
*** fanshi/fix-gemini-key-for-aidermacs
#+begin_src emacs-lisp :tangle yes
(defun fanshi/fix-gemini-key-for-aidermacs ()
  "to fix api key for gemini, the key is not initailised right when we start emacs (`password-store-get` didn't ask for my pass and gave me some wrong binary)"
  (interactive)
  (setq aidermacs-args `("--api-key" ,(concat "gemini=" (password-store-get "Google/jackychany321@gmail.com/gemini_key")))))
#+end_src
** Org AI

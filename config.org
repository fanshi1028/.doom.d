...
* TEMP FIX
#+begin_example
Error (doom-first-file-hook): Error running hook "global-git-commit-mode" because: (void-function transient--set-layout)
#+end_example
- issue :: https://github.com/doomemacs/doomemacs/issues/8541
- TEMP FIX from :: https://github.com/doomemacs/doomemacs/issues/8541#issuecomment-3421113668
#+begin_src emacs-lisp :tangle no

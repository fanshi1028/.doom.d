...
(after! gptel
  (gptel-make-preset 'research
    ...
    :use-context (with-temp-buffer (insert-file-contents "./gptel/research.md") (buffer-string))
    :context nil))
#+end_src
*** Instruct
#+begin_src emacs-lisp :tangle yes
...
(after! gptel
  (gptel-make-preset 'coding
    ...
    :use-context (with-temp-buffer (insert-file-contents "./gptel/coding.md") (buffer-string))
    :context nil))
#+end_src
*** Heavy
#+begin_src emacs-lisp :tangle yes
          ...
          (gptel-request
              (format
               "classify the below prompt into one of the classes in %s,
                  coding: if it is an executable coding task with clear scope and objective
                  do: if it is a simple instruction
                  research: if it require deeper research for specific topic to answer
            ...
            (lambda (classification _info)
              (progn
                (when fanshi/show-prompt-classification
                  (goto-char (+ (point-min) (length (gptel-prompt-prefix-string))))

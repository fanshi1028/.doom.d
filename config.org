...
(after! gptel
  (defvar fanshi/gptel-local-llama
   (gptel-make-openai "Local Llama"
     ...
     :protocol "http"
     :stream t
     :models (fanshi/gptel--load-models-from-ini 'Llama))))
#+end_src
**** mlx_lm server
#+begin_src emacs-lisp :tangle no
(after! gptel
  (defvar fanshi/gptel-local-mlx
   (gptel-make-openai "Local MLX"
     ...
     :protocol "http"
     :stream t
     :models (fanshi/gptel--load-models-from-ini 'Mlx))))
#+end_src
...
(after! gptel
  (setopt
   ...
   gptel-backend fanshi/gptel-local-llama
   gptel-model 'mlx-community/Qwen3.5-122B-A10B-6bit)

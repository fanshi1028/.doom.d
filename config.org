...
#+end_src
** Default to save to .gptel-agent under project root when saving gptel-agent's chat
#+begin_src elisp :tangle yes
(after! gptel
...
associated, or a prefix arg was used, does nothing."
  ...
  (defun fanshi/gptel-agent--setup-auto-save ()
    "Set up auto-save to ./gptel-agent/ for gptel-agent buffers."
    (add-hook 'before-save-hook #'fanshi/gptel-agent--auto-assign-filename
              nil 'local))

  (add-hook 'gptel-mode-hook #'fanshi/gptel-agent--setup-auto-save))
#+end_src

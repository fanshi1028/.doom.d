...
(after! gptel
  ...
  (gptel-make-preset 'gptel-agent
    ...
    :tools '("Agent" "TodoWrite" "Glob" "Grep" "Read" "WebSearch" "WebFetch" "YouTube")
    :use-context 'system
    :context nil))
#+end_src
*** Research
...
(after! gptel
  (gptel-make-preset 'do
    ...
    :model 'Qwen3.6-35B-A3B
    :tools '("Glob" "Grep" "Read" "Insert" "Edit" "Write" "Bash")
    :use-context 'system
    :context nil))
#+end_src
*** Coding
...
(after! gptel
  (gptel-make-preset 'coding
    ...
    :model 'Qwen3.6-35B-A3B
    :tools '("TodoWrite" "Glob" "Grep" "Read" "Insert" "Edit" "Write" "Bash" "WebFetch")
...
(after! gptel
  (gptel-make-preset 'heavy
    ...
    :model 'Qwen3.6-27B
    ;; :context '("./.grammar_rules.md" "./jargonfile.md")
    ))
#+end_src
** Backend
*** Local

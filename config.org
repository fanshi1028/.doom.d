...
** Path vs Dictation issues
- Opening with GUI apps got me not such issue. But some how we lose the mac dictation
- Opening from terminal is the opposite
*** Solution
- ref :: https://stackoverflow.com/a/29214791
#+begin_src emacs-lisp :tangle yes
(setopt shell-file-name "bash")
#+end_src
And use the GUI apps. We keep both.

...
#+begin_src emacs-lisp :tangle yes
(after! org-agenda
  (setq! org-agenda-files '("~/Personal/org/gtd/")
...
(after! writeroom-mode
  (setq! writeroom-major-modes '(text-mode org-mode prog-mode))
...
*** Copilot
#+begin_src emacs-lisp :tangle no
(after! gptel (setq! gptel-backend (gptel-make-gh-copilot "Copilot")))
#+end_src
*** Gemini
**** default
#+begin_src emacs-lisp :tangle no
...
(use-package! agent-shell
  :config
  (setq! agent-shell-opencode-acp-command `(,(executable-find "nono") "run" "--profile" "opencode" "--allow-cwd" "--" ,(executable-find "opencode") "acp"))
  (setq! agent-shell-pi-acp-command `(,(executable-find "nono") "run" "--profile" "pi-coding-agent" "--allow-cwd" "--" ,(executable-find "pi-acp"))))
#+end_src
* Use spatial-window
#+begin_src emacs-lisp :tangle yes
(use-package! spatial-window
  ...
  :config
  (setq! spatial-window-expert-mode t))
#+end_src
* Custom
#+begin_src emacs-lisp :tangle yes

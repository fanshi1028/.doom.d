...
(defun fasnhi/init-new-project (&optional dir)
    "Init a directory as a new project"
    (interactive)

    ;; NOTE: init git repo
    (require 'magit)
    (magit-call-git "init" (magit-convert-filename-for-git (expand-file-name dir)))
...
(defun fanshi/clone-from-project (project)
    ...
    (if-let ((default-directory project) ;; FIXME
        ...
        (progn
          ...
          ;; NOTE: init project
          (fasnhi/init-new-project new-project-directory)
